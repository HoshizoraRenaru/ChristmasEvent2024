...
object MirroredChristmasDestroyerItemManager {
    ...
    fun createMirroredChristmasDestroyer(): ItemStack {
        ...
        meta?.let {
            it.setDisplayName(ChatColor.translateAlternateColorCodes('&', "&5&l&kL &r&f➶&9-͙&f˚&9 ༘&f✶ &1&l반사된 &d&l크&9&l리&d&l스&9&l마&d&l스 &d&l파괴자 &r&9｡･:*&f˚&9:✧&f｡ &5&l&kL&f"))
            it.lore = listOf(
                "",
                ...
                "${ChatColor.RESET}${ChatColor.GRAY}적용한다. 쉴드 상태에서 받은 피해를 공격자",
                "${ChatColor.RESET}${ChatColor.GRAY}에게 반사한다. 1회 반사 후 쉴드는 파괴된다.",
